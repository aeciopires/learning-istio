...
vim $ISTIO_DIR_BASE/meshpolicy.yaml

kubectl apply -f $ISTIO_DIR_BASE/meshpolicy.yaml
...
vim $ISTIO_DIR_BASE/destination-rule-meshpolicy.yaml

kubectl apply -f $ISTIO_DIR_BASE/destination-rule-meshpolicy.yaml
...
vim $ISTIO_DIR_BASE/destination-rule-fix-girus-conn.yaml


kubectl apply -f $ISTIO_DIR_BASE/destination-rule-fix-girus-conn.yaml
...
vim $ISTIO_DIR_BASE/policy-enable-mtls-namespace.yaml

kubectl apply -f $ISTIO_DIR_BASE/policy-enable-mtls-namespace.yaml
...
vim $ISTIO_DIR_BASE/destination-rule-enable-mtls-namespace.yaml

kubectl apply -f $ISTIO_DIR_BASE/destination-rule-enable-mtls-namespace.yaml
...
vim $ISTIO_DIR_BASE/policy-enable-mtls-service.yaml

kubectl apply -f $ISTIO_DIR_BASE/policy-enable-mtls-service.yaml

for from in "giropops" "strigus" "girus"; do for to in "giropops" "strigus" "girus"; do kubectl exec $(kubectl get pod -l app=sleep -n ${from} -o jsonpath={.items..metadata.name}) -c sleep -n ${from} -- curl "http://httpbin.${to}:8000/ip" -s -o /dev/null -w "sleep.${from} to httpbin.${to}: %{http_code}\n"; done; done

vim $ISTIO_DIR_BASE/destination-rule-enable-mtls-service.yaml

kubectl apply -f $ISTIO_DIR_BASE/destination-rule-enable-mtls-service.yaml

for from in "giropops" "strigus" "girus"; do for to in "giropops" "strigus" "girus"; do kubectl exec $(kubectl get pod -l app=sleep -n ${from} -o jsonpath={.items..metadata.name}) -c sleep -n ${from} -- curl "http://httpbin.${to}:8000/ip" -s -o /dev/null -w "sleep.${from} to httpbin.${to}: %{http_code}\n"; done; done

vim $ISTIO_DIR_BASE/policy-enable-mtls-specific-service.yaml

kubectl apply -f $ISTIO_DIR_BASE/policy-enable-mtls-specific-service.yaml

vim $ISTIO_DIR_BASE/destination-rule-specific-service.yaml

kubectl apply -f $ISTIO_DIR_BASE/destination-rule-specific-service.yaml
